...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% load the network after phase1 of the same strategy
load('experiments_results/trained_nets/strategy3_trials/phase1_trial4.mat'); % this will create variable 'trained_net'
phase1_trained_layers = restructure_network_handle_hyperspectral(trained_net);


% select how much to train
% fine tune just first conv layer
phase1_trained_layers(2).WeightLearnRateFactor=1;
phase1_trained_layers(5).WeightLearnRateFactor=0;
phase1_trained_layers(8).WeightLearnRateFactor=0;
phase1_trained_layers(11).WeightLearnRateFactor=0;
phase1_trained_layers(13).WeightLearnRateFactor=0;
phase1_trained_layers(2).BiasLearnRateFactor=1;
phase1_trained_layers(5).BiasLearnRateFactor=0;
phase1_trained_layers(8).BiasLearnRateFactor=0;
phase1_trained_layers(11).BiasLearnRateFactor=0;
phase1_trained_layers(13).BiasLearnRateFactor=0;
...
phase2_trained_net = trainNetwork(imagesTrain,imagesLabelsTrain,phase1_trained_layers, opts);
[YTest,score] = classify(phase2_trained_net,imagesTest);
...
%save('experiments_results/trained_nets/strategy3_trials/phase2_trial4', 'phase2_trained_net');
