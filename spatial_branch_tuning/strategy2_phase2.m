...
load('experiments_results/trained_nets/strategy2_phase1_0001'); % this will create variable 'trained_net'
phase1_trained_layers = restructure_network_handle_hyperspectral(trained_net, true);
...
phase1_trained_layers(11).WeightLearnRateFactor=1;
phase1_trained_layers(13).WeightLearnRateFactor=1;
...
phase1_trained_layers(11).BiasLearnRateFactor=1;
phase1_trained_layers(13).BiasLearnRateFactor=1;
