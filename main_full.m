...
accuracy = sum(classifications == imagesLabelsTest)/numel(imagesLabelsTest);
confmat = confusionmat(imagesLabelsTest,classifications,'Order', {'clearwood', 'softrot', 'brownstain', 'bluestain'});
